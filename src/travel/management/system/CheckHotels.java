...
public class CheckHotels extends JFrame implements Runnable{
    ...
    CheckHotels() {
        ...
        caption = new JLabel();
        caption.setBounds(50, 30, 1000, 70);
    ...
    public void run() {
        ...
        String[] text = new String[] {"JW Mariott Hotel", "Madrin Oriental Hotel", "Four Seasons Hotel", "Raddisson Blue Hotel", "Classio Hotel", "The Bay Club Hotel", "Breeze Blow Hotel", "The Taj Hotel", "Happy Morning Hotel", "River View Hotel"};
        try{
            for(int i=0; i<=9; i++) {
