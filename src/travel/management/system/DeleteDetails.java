...
public class DeleteDetails extends JFrame implements ActionListener{
    ...
    public void actionPerformed (ActionEvent ae) {
        try{
            Conn conn = new Conn();
            conn.s.executeUpdate("delete from account where username = '"+username+"'");
            conn.s.executeUpdate("delete from customer where username = '"+username+"'");
            conn.s.executeUpdate("delete from bookpackage where username = '"+username+"'");
            conn.s.executeUpdate("delete from bookhotel where username = '"+username+"'");
